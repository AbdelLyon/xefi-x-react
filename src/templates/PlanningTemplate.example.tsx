...
// import { PlanningTemplate, PlanningDay, PlanningGroup, PlanningItem, PlanningUser } from "@xefi/x-react/templates"
...
//           id: "user-1",
//           name: "Alice Martin",
//           data: { email: "alice@company.com", department: "Frontend", remainingDays: 25 }
//         },
//         {
//           id: "user-2",
//           name: "Bob Dupont",
//           data: { email: "bob@company.com", department: "Backend", remainingDays: 18 }
//         }
//       ]
//     },
//     {
...
//           id: "user-3",
//           name: "Claire Moreau",
//           data: { email: "claire@company.com", department: "UX/UI", remainingDays: 22 }
//         }
//       ]
//     }
//   ]
...
//   return (
//     <div className="p-6">
//       <h1 className="mb-4 text-2xl font-bold">Planning des Congés - Décembre 2024</h1>
...
//   const periodDaysWithNativeDate: PlanningDay<Date>[] = Array.from({ length: 14 }, (_, i) => {
...
//           id: "dev-1",
//           name: "Sarah Dev",
//           data: { skills: ["React", "Node.js"], hourlyRate: 45, availability: 100 }
//         },
//         {
//           id: "dev-2",
//           name: "Mike Frontend",
...
//       if (fmt === "DD") return date.getDate().toString().padStart(2, '0')
//       if (fmt === "ddd") return ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"][date.getDay()]
...
//   return (
//     <div className="p-6">
//       <h1 className="mb-4 text-2xl font-bold">Planning Projet - Décembre 2024</h1>
