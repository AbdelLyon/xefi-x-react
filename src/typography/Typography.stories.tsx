...
export const Colors: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      <Typography color="primary-600">Texte en couleur primaire</Typography>
      <Typography color="secondary-600">Texte en couleur secondaire</Typography>
      <Typography color="success-600">Texte en couleur de succès</Typography>
      <Typography color="warning-600">
        Texte en couleur d'avertissement
      </Typography>
      <Typography color="danger-600">Texte en couleur de danger</Typography>
      <Typography color="gray-500">Texte en gris neutre</Typography>
      <Typography color="slate-600">Texte en gris ardoise</Typography>
    </div>
  ),
}
  ...
  render: () => (
    <div className="max-w-2xl space-y-4">
      ...
      >
        ...
        composant Typography pour différents éléments sémantiques."
      </Typography>
  ...
  render: () => (
    <div className="mx-auto max-w-4xl space-y-8 p-8">
      ...
      <article className="space-y-6">
        ...
        <Typography variant="base">
          Le composant Typography est un élément fondamental de notre système de
        ...
        <div className="overflow-x-auto rounded-lg bg-gray-900 p-6">
          <Typography variant="small" color="gray-300" className="font-mono">
            <span className="text-blue-400">import</span> {`{ Typography }`}{" "}
