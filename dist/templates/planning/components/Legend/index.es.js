...
const Legend = ({
  ...
  const renderLegendItem = useCallback(
    (item, isVisible = true) => /* @__PURE__ */ jsxs(
      "div",
      {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
          ...
          config.toggleable && /* @__PURE__ */ jsx(
            Tooltip,
            {
              content: "Gérer la visibilité",
              trigger: /* @__PURE__ */ jsx(Button, { size: "sm", variant: "light", className: "px-2 text-xs", children: /* @__PURE__ */ jsx(IconEye, { className: "size-3" }) })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs(
